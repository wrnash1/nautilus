<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="/rentals/reservations/create" class="btn btn-primary">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="/rentals/reservations" class="row g-3">
            <div class="col-md-4">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/rentals/reservations/<?= $res['id'] ?>" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
