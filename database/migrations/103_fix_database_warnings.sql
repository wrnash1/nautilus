...
SET @sql = IF(@column_exists = 0,
    'ALTER TABLE customers ADD COLUMN tenant_id INT UNSIGNED NOT NULL DEFAULT 1 AFTER id, ADD INDEX idx_tenant_id (tenant_id)',
...
SET @sql = IF(@column_exists = 0,
    'ALTER TABLE products ADD COLUMN tenant_id INT UNSIGNED NOT NULL DEFAULT 1 AFTER id, ADD INDEX idx_tenant_id (tenant_id)',
...
SET @sql = IF(@column_exists = 0,
    'ALTER TABLE users ADD COLUMN tenant_id INT UNSIGNED NOT NULL DEFAULT 1 AFTER id, ADD INDEX idx_tenant_id (tenant_id)',
...
SET @sql = IF(@column_exists = 0,
    'ALTER TABLE courses ADD COLUMN tenant_id INT UNSIGNED NOT NULL DEFAULT 1 AFTER id, ADD INDEX idx_tenant_id (tenant_id)',
...
SET @sql = IF(@column_exists = 0,
    'ALTER TABLE trips ADD COLUMN tenant_id INT UNSIGNED NOT NULL DEFAULT 1 AFTER id, ADD INDEX idx_tenant_id (tenant_id)',
