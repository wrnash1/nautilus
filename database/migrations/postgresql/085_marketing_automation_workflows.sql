...
CREATE TABLE IF NOT EXISTS "automation_workflows" (
    ...
    "re_entry_wait_days" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "automation_workflow_steps" (
    ...
    "send_day_of_week" SMALLINT NULL COMMENT '0=Sunday, 6=Saturday',
    ...
    "true_next_step_id" INTEGER NULL COMMENT 'Step to go to if condition is true',
    "false_next_step_id" INTEGER NULL COMMENT 'Step to go to if condition is false',

    -- A/B Testing
    "is_ab_test" BOOLEAN DEFAULT FALSE,
    "ab_split_percentage" SMALLINT NULL COMMENT 'Percentage for variant A',
...
CREATE TABLE IF NOT EXISTS "automation_workflow_members" (
    ...
    "current_step_entered_at" TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS "automation_step_executions" (
    "id" BIGSERIAL PRIMARY KEY,
    "workflow_member_id" BIGINT NOT NULL,
    "workflow_id" INTEGER NOT NULL,
