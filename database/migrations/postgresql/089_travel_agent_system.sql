...
CREATE TABLE IF NOT EXISTS "travel_destinations" (
    ...
    "dive_site_count" INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "dive_resorts" (
    ...
    "boats_available" INTEGER DEFAULT 1,
    "dives_per_day" INTEGER DEFAULT 2,
    ...
    -- Ratings
    "star_rating" SMALLINT NULL COMMENT '1-5 stars',
...
CREATE TABLE IF NOT EXISTS "liveaboard_boats" (
    ...
    "dives_per_day" INTEGER DEFAULT 4,
...
CREATE TABLE IF NOT EXISTS "travel_packages" (
    ...
    "resort_id" INTEGER NULL,
    "liveaboard_id" INTEGER NULL,
    ...
    -- Diving
    "total_dives_included" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "travel_bookings" (
    ...
    -- Staff
    "booked_by" INTEGER NULL COMMENT 'Staff who made the booking',
    "assigned_to" INTEGER NULL COMMENT 'Travel coordinator',
...
CREATE TABLE IF NOT EXISTS "travel_reviews" (
    ...
    -- Rating
    "overall_rating" SMALLINT NOT NULL COMMENT '1-5 stars',
    "dive_sites_rating" SMALLINT NULL,
    "accommodation_rating" SMALLINT NULL,
    "food_rating" SMALLINT NULL,
    "staff_rating" SMALLINT NULL,
