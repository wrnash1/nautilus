...
CREATE TABLE IF NOT EXISTS "rma_requests" (
  ...
  "transaction_id" BIGINT COMMENT 'Original sale transaction',
  "vendor_id" INTEGER COMMENT 'If returning to vendor',
  ...
  "approved_by" INTEGER COMMENT 'Staff member who approved',
  "processed_by" INTEGER COMMENT 'Staff member who processed',
...
CREATE TABLE IF NOT EXISTS "rma_items" (
  ...
  "transaction_item_id" BIGINT COMMENT 'Original transaction item',
...
CREATE TABLE IF NOT EXISTS "product_import_jobs" (
  ...
  "vendor_id" INTEGER COMMENT 'Associated vendor if applicable',
...
CREATE TABLE IF NOT EXISTS "product_import_preview" (
  ...
  "existing_product_id" INTEGER COMMENT 'ID if updating existing',
  "created_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "vendor_price_lists" (
  ...
  "import_job_id" INTEGER COMMENT 'Link to import job if imported',
