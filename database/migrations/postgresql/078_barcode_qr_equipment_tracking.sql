...
CREATE TABLE IF NOT EXISTS "equipment_barcodes" (
    ...
    -- Equipment Reference
    "equipment_id" INTEGER NULL COMMENT 'Links to rental_equipment or inventory item',
...
CREATE TABLE IF NOT EXISTS "barcode_scan_history" (
    ...
    "customer_id" INTEGER NULL COMMENT 'If checkout/checkin',

    -- Related Transaction
    "rental_id" INTEGER NULL,
    "service_record_id" INTEGER NULL,
