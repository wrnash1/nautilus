...
CREATE TABLE IF NOT EXISTS "course_student_records" (
    ...
    "instructor_id" INTEGER COMMENT 'Primary instructor',
    "assistant_instructor_id" INTEGER COMMENT 'Assistant if applicable',
...
CREATE TABLE IF NOT EXISTS "student_skills_assessment" (
    ...
    -- Assessment Details
    "assessed_by" INTEGER COMMENT 'Instructor who assessed',
