...
CREATE TABLE IF NOT EXISTS "training_sessions" (
    ...
    -- Instructor
    "lead_instructor_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "skills_assessments" (
    ...
    "student_id" INTEGER NOT NULL,
    "assessor_id" INTEGER NOT NULL COMMENT 'Instructor ID',
    "program_id" INTEGER NOT NULL,
    ...
    "skills_passed" INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "instructor_qualifications" (
    "id" SERIAL PRIMARY KEY,
    "tenant_id" INTEGER NOT NULL,
    "instructor_id" INTEGER NOT NULL COMMENT 'Staff/User ID',
    ...
    -- Teaching Stats
    "total_students_certified" INTEGER DEFAULT 0,
