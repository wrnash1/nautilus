...
ADD COLUMN IF NOT EXISTS "verified_by" INTEGER NULL AFTER "verified_at";
...
CREATE TABLE IF NOT EXISTS "trip_dive_sites" (
  "id" SERIAL PRIMARY KEY,
  "trip_schedule_id" INTEGER NOT NULL,
  "dive_site_id" INTEGER NOT NULL,
  "planned_date" DATE,
  "dive_number" INT,
  "notes" TEXT,
...
CREATE TABLE IF NOT EXISTS "travel_packet_participants" (
  "id" SERIAL PRIMARY KEY,
  "travel_packet_id" INTEGER NOT NULL,
  "customer_id" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "vendor_catalog_items" (
  "id" SERIAL PRIMARY KEY,
  "vendor_catalog_id" INTEGER NOT NULL,
  ...
  "imported_to_product_id" INTEGER NULL,
