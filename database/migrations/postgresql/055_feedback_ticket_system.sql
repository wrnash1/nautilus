...
CREATE TABLE IF NOT EXISTS "feedback_tickets" (
    ...
    "submitted_by_user_id" INTEGER COMMENT 'User who submitted (if logged in)',
    ...
    "assigned_to" INTEGER COMMENT 'Developer assigned',
    ...
    "duplicate_of" INTEGER COMMENT 'If duplicate, link to original',
