...
CREATE TABLE IF NOT EXISTS "customer_referral_codes" (
    ...
    -- Sharing Stats
    "shared_via_email" INTEGER DEFAULT 0,
    "shared_via_sms" INTEGER DEFAULT 0,
    "shared_via_social" INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "referrals" (
    ...
    "program_id" INTEGER NOT NULL,
    "referrer_id" INTEGER NOT NULL COMMENT 'Customer who referred',
    "referee_id" INTEGER NULL COMMENT 'New customer (null until signup)',
    "tenant_id" INTEGER NOT NULL,
    ...
    "converted_at" TIMESTAMP NULL COMMENT 'When they completed qualifying action',

    -- Status
    "status" ENUM('clicked', 'signed_up', 'qualified', 'rewarded', 'expired', 'rejected') DEFAULT 'clicked',

    -- Conversion Details
    "conversion_order_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "social_media_posts" (
    ...
    "campaign_id" INTEGER NULL COMMENT 'Associated marketing campaign',
...
CREATE TABLE IF NOT EXISTS "social_media_leads" (
    ...
    -- Processing
    "customer_id" INTEGER NULL COMMENT 'Created customer record',
    "processed" BOOLEAN DEFAULT FALSE,
    "processed_at" TIMESTAMP NULL,
    "assigned_to" INTEGER NULL COMMENT 'Staff member',
