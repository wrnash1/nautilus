...
CREATE TABLE IF NOT EXISTS "inventory_locations" (
    ...
    -- Capacity
    "total_capacity_sqft" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "product_master" (
    "id" SERIAL PRIMARY KEY,
    "tenant_id" INTEGER NOT NULL,
    "product_id" INTEGER NULL COMMENT 'Link to existing products table',
    ...
    "replacement_product_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "inventory_stock_levels" (
    ...
    "reorder_triggered_at" TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS "serialized_inventory" (
    ...
    -- Ownership
    "customer_id" INTEGER NULL COMMENT 'If sold or rented to customer',
...
CREATE TABLE IF NOT EXISTS "inventory_movements" (
    ...
    -- Audit
    "performed_by" INTEGER NULL COMMENT 'User ID',
