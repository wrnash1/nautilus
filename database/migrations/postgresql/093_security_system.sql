...
CREATE TABLE IF NOT EXISTS "security_cameras" (
    ...
    "location_id" INTEGER NULL COMMENT 'Link to inventory_locations',
    ...
    "last_recording_at" TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS "camera_events" (
    ...
    -- Related Incident
    "security_incident_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "access_credentials" (
    ...
    "temp_access_start" TIMESTAMP NULL,
    "temp_access_end" TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS "security_incidents" (
    ...
    -- Parties Involved
    "reporter_id" INTEGER NULL COMMENT 'Employee who reported',
