...
INSERT INTO subscription_plans (plan_name, plan_code, description, monthly_price, yearly_price, max_users, max_storage_mb, max_products, max_transactions_per_month, features, is_popular) VALUES
...
-- ALTER TABLE users ADD COLUMN tenant_id INTEGER NULL AFTER id;
...
ALTER TABLE customers ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE customers ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE products ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE products ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE product_categories ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE product_categories ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE pos_transactions ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE pos_transactions ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE courses ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE courses ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE equipment ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
ALTER TABLE equipment ADD INDEX IF NOT EXISTS idx_tenant_id (tenant_id);

ALTER TABLE equipment_rentals ADD COLUMN IF NOT EXISTS tenant_id INTEGER NULL AFTER id;
