...
CREATE TABLE IF NOT EXISTS "layaway_agreements" (
    ...
    "reservation_location_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "layaway_payment_schedules" (
    ...
    "paid_date" DATE NULL,
    "payment_id" INTEGER NULL COMMENT 'FK to payments table',
...
CREATE TABLE IF NOT EXISTS "diving_clubs" (
    ...
    "vice_president_id" INTEGER NULL,
    "treasurer_id" INTEGER NULL,
...
CREATE TABLE IF NOT EXISTS "buddy_pairs" (
    ...
    -- Divers
    "diver1_id" INTEGER NOT NULL,
    "diver2_id" INTEGER NOT NULL,

    -- Relationship
    "relationship_type" ENUM('permanent', 'trip_specific', 'single_dive', 'preferred') DEFAULT 'trip_specific',
    "paired_for_trip_id" INTEGER NULL COMMENT 'Specific trip/booking',
