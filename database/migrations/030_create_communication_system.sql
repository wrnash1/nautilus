...
CREATE TABLE IF NOT EXISTS communication_log (
    ...
    campaign_id INTEGER,  -- If part of a campaign
    subject VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS customer_communication_preferences (
    ...
    marketing_email BOOLEAN DEFAULT 1,
    marketing_sms BOOLEAN DEFAULT 0,  -- Opt-in required for SMS marketing
    marketing_push BOOLEAN DEFAULT 1,
    transactional_email BOOLEAN DEFAULT 1,  -- Order confirmations, receipts
    transactional_sms BOOLEAN DEFAULT 1,  -- Booking reminders, alerts
    reminder_notifications BOOLEAN DEFAULT 1,  -- Appointment/trip reminders
...
INSERT OR IGNORE INTO communication_templates (id, name, template_type, category, subject, body, variables) VALUES
