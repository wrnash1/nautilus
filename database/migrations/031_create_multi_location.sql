...
CREATE TABLE IF NOT EXISTS locations (
    ...
    is_default BOOLEAN DEFAULT 0,  -- Default location for new products
    can_sell BOOLEAN DEFAULT 1,  -- Can this location sell products?
    can_ship BOOLEAN DEFAULT 1,  -- Can this location ship products?
    priority INTEGER DEFAULT 0,  -- Fulfillment priority (higher = preferred)
...
CREATE TABLE IF NOT EXISTS location_inventory (
    ...
    last_count_variance INTEGER DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
INSERT OR IGNORE INTO locations (id, name, code, location_type, is_active, is_default, can_sell, can_ship, priority) VALUES
(1, 'Main Store', 'MAIN', 'store', 1, 1, 1, 1, 100);

-- Migrate existing product inventory to location_inventory
INSERT OR IGNORE INTO location_inventory (location_id, product_id, quantity_on_hand, quantity_available)
SELECT
    1 AS location_id,
    id AS product_id,
