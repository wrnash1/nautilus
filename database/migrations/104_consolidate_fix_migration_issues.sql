...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE customer_tags ADD COLUMN tenant_id INT UNSIGNED DEFAULT 1 AFTER id', 'SELECT 1');
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE customer_tags ADD COLUMN is_active TINYINT(1) DEFAULT 1 AFTER description', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE certification_agencies ADD COLUMN verification_enabled TINYINT(1) DEFAULT 0', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE customers ADD COLUMN tenant_id INT UNSIGNED DEFAULT 1 AFTER id', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE products ADD COLUMN tenant_id INT UNSIGNED DEFAULT 1 AFTER id', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE users ADD COLUMN tenant_id INT UNSIGNED DEFAULT 1 AFTER id', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@table_exists > 0 AND @col_exists = 0, 'ALTER TABLE courses ADD COLUMN tenant_id INT UNSIGNED DEFAULT 1 AFTER id', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
CREATE TABLE IF NOT EXISTS `gift_cards` (
    ...
    `purchaser_id` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `customer_waivers` (
    ...
    `tenant_id` INT UNSIGNED DEFAULT 1,
    `customer_id` INT UNSIGNED NOT NULL,
    `waiver_template_id` INT UNSIGNED NULL,
