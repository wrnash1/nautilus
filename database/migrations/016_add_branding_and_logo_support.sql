...
-- Insert branding-related settings into the general category (idempotent)
INSERT IGNORE INTO `settings` (`category`, `key`, `value`, `type`, `description`, `updated_at`)
VALUES
...
-- Record expected directory structure in system metadata (idempotent)
INSERT IGNORE INTO `system_metadata` (`meta_key`, `meta_value`, `updated_at`)
VALUES
  ...
  ('max_logo_file_size', '5242880', NOW()),
...
-- Record that system needs logo setup (idempotent)
INSERT IGNORE INTO `settings` (`category`, `key`, `value`, `type`, `description`, `updated_at`)
VALUES
