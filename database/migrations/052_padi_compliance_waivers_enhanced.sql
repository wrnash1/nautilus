...
INSERT INTO `waiver_templates` (`waiver_type`, `template_name`, `padi_form_number`, `version`, `waiver_title`, `acknowledgment_items`, `requires_witness`, `validity_days`, `is_active`, `effective_date`) VALUES
