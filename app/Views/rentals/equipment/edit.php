<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/store/rentals/equipment/<?= $equipment['id'] ?>" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="/store/rentals/equipment/<?= $equipment['id'] ?>">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="equipment_code" name="equipment_code"
                        value="<?= htmlspecialchars($equipment['equipment_code']) ?>" required readonly>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="size" name="size"
                        value="<?= htmlspecialchars($equipment['size'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="manufacturer" name="manufacturer"
                        value="<?= htmlspecialchars($equipment['manufacturer'] ?? '') ?>">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="daily_rate" name="daily_rate"
                        value="<?= $equipment['daily_rate'] ?>" required>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="weekend_rate" name="weekend_rate" value="<?= $equipment['weekend_rate'] ?? '' ?>" placeholder="Fri-Sun rate">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="status" name="status" required>
                        ...
                        <option value="maintenance" <?= $equipment['status'] === 'maintenance' ? 'selected' : '' ?>>
                            Maintenance</option>
                        <option value="damaged" <?= $equipment['status'] === 'damaged' ? 'selected' : '' ?>>Damaged
                        </option>
                        <option value="retired" <?= $equipment['status'] === 'retired' ? 'selected' : '' ?>>Retired
                        </option>
                    </select>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="condition" name="condition" required>
                        <option value="excellent" <?= $equipment['condition'] === 'excellent' ? 'selected' : '' ?>>
                            Excellent</option>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="notes" name="notes"
                    rows="3"><?= htmlspecialchars($equipment['notes'] ?? '') ?></textarea>
            </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="/store/rentals/equipment/<?= $equipment['id'] ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>