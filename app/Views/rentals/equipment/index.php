<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <?php if (hasPermission('rentals.create')): ?>
            <a href="/store/rentals/equipment/create" class="btn btn-primary">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="/store/rentals" class="row g-3">
            <div class="col-md-3">
                    ...
                    <?php else: ?>
                        <?php foreach ($equipment as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/store/rentals/equipment/<?= $item['id'] ?>" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <?php if (hasPermission('rentals.edit')): ?>
                                        <a href="/store/rentals/equipment/<?= $item['id'] ?>/edit" class="btn btn-sm btn-warning">
