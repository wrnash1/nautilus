<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/store/rentals/reservations" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="/store/rentals/reservations" id="reservationForm">
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <a href="/store/rentals/reservations" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        function loadAvailableEquipment(startDate, endDate) {
            $.get('/store/rentals/available-equipment', { start_date: startDate, end_date: endDate }, function (data) {
                equipmentData = data;
                renderEquipmentList();
            });
        }
