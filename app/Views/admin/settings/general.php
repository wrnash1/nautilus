...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/store/admin/settings/upload-logo" enctype="multipart/form-data" id="logoUploadForm">
            ...
            <div class="card-body">
                <form method="POST" action="/store/admin/settings/update">
                    ...
                    <div class="mb-3">
                         ...
                         <textarea name="business_hours" id="business_hours" class="form-control" rows="3"><?= htmlspecialchars($settings['business_hours'] ?? '') ?></textarea>
                         <small class="text-muted">e.g., Mon-Fri: 9am - 6pm, Sat: 10am - 4pm</small>
                    </div>
