...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'Shop') ?> - <?= htmlspecialchars($branding['company_name'] ?? 'Nautilus Dive Shop') ?></title>
    ...
    <style>
        :root {
            ...
            --secondary-color: <?= $branding['secondary_color'] ?? '#dc004e' ?>;
            --accent-color: <?= $branding['accent_color'] ?? '#f50057' ?>;
        }
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <span class="ms-3"><i class="bi bi-envelope"></i> info@diveshop.com</span>
                </div>
                <div class="col-md-6 text-md-end">
                    <?php if (isset($_SESSION['customer_id'])): ?>
                        <a href="/portal/dashboard" class="text-decoration-none"><i class="bi bi-person-circle"></i> My Account</a>
                        <a href="/portal/logout" class="text-decoration-none ms-3"><i class="bi bi-box-arrow-right"></i> Logout</a>
                    <?php else: ?>
        ...
        <div class="container">
            <a class="navbar-brand" href="/">
                <?php if (!empty($branding['logo_url'])): ?>
                    <img src="<?= htmlspecialchars($branding['logo_url']) ?>" alt="<?= htmlspecialchars($branding['company_name'] ?? 'Logo') ?>">
                <?php else: ?>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="text-center">
                <p class="mb-0">&copy; <?= date('Y') ?> <?= htmlspecialchars($branding['company_name'] ?? 'Nautilus Dive Shop') ?>. All rights reserved.</p>
