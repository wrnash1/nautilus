                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-muted mb-0">123 Ocean Drive<br>Blue Bay, FL 33000</p>
                                </div>
                            </div>
                             ...
                             <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-muted mb-0"><a href="tel:5551234567" class="text-decoration-none text-muted">(555) 123-4567</a></p>
                                </div>
                            </div>
                             ...
                             <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-muted mb-0"><a href="mailto:info@nautilusdive.com" class="text-decoration-none text-muted">info@nautilusdive.com</a></p>
                                </div>
                            </div>
                             ...
                             <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-muted mb-0">Mon-Fri: 10am - 7pm<br>Sat: 10am - 6pm<br>Sun: 12pm - 5pm</p>
                                </div>
                            </div>
                        ...
                        <form action="#" method="POST">
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="you@example.com">
                            </div>
                            
                            <div class="mb-4">
                                <label for="message" class="form-label fw-medium text-gray-700">Message</label>
                                <textarea id="message" name="message" rows="4" class="form-control form-control-lg" placeholder="How can we help?"></textarea>
                            </div>
