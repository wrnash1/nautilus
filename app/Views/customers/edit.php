...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/customers/<?= $customer['id'] ?>"><?= htmlspecialchars($customer['first_name'] . ' ' . $customer['last_name']) ?></a></li>
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="/customers/<?= $customer['id'] ?>" id="customerForm" enctype="multipart/form-data">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="customer_type" 
                                       id="typeB2C" value="B2C" <?= $customer['customer_type'] === 'B2C' ? 'checked' : '' ?> onchange="toggleCustomerType()">
                                <label class="form-check-label" for="typeB2C">B2C (Individual)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="customer_type" 
                                       id="typeB2B" value="B2B" <?= $customer['customer_type'] === 'B2B' ? 'checked' : '' ?> onchange="toggleCustomerType()">
                                <label class="form-check-label" for="typeB2B">B2B (Business)</label>
                            </div>
                        </div>
                    </div>
                    
                    <div id="b2bFields" style="display: <?= $customer['customer_type'] === 'B2B' ? 'block' : 'none' ?>;">
                        <div class="mb-3">
                    ...
                    <div id="b2cFields" style="display: <?= $customer['customer_type'] === 'B2C' ? 'block' : 'none' ?>;">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                    ...
                    <div id="b2bFieldsExtra" style="display: <?= $customer['customer_type'] === 'B2B' ? 'block' : 'none' ?>;">
                        <div class="row">
                        ...
                        <div class="mb-3" id="taxExemptNumberField" style="display: <?= !empty($customer['tax_exempt']) ? 'block' : 'none' ?>;">
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= htmlspecialchars($cert['agency_name'] ?? $cert['agency_code'] ?? '-') ?></td>
                                    <td><?= htmlspecialchars($cert['certification_level'] ?? '-') ?></td>
                                    <td><?= htmlspecialchars($cert['certification_number'] ?? '-') ?></td>
                                    <td><?= $cert['issue_date'] ? date('M j, Y', strtotime($cert['issue_date'])) : '-' ?></td>
                                    <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="cert_level" placeholder="e.g., Open Water, Advanced">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label form-label-sm">Cert Number</label>
                                    <input type="text" class="form-control form-control-sm" id="cert_number" placeholder="Certification #">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 d-flex align-items-end">
                                    <button type="button" class="btn btn-sm btn-success w-100" onclick="addCertification()">
