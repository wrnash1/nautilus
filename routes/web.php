...
$router->get('/services', 'Storefront\\ServicesController@index');
$router->get('/memberships', 'Storefront\\MembershipController@index');
$router->get('/memberships/join/{id}', 'Storefront\\MembershipController@join');
$router->post('/memberships/checkout', 'Storefront\\MembershipController@checkout');
...
$router->get('/store/storefront/carousel', 'Admin\\Storefront\\CarouselController@index', [AuthMiddleware::class]);
$router->get('/store/storefront/carousel/create', 'Admin\\Storefront\\CarouselController@create', [AuthMiddleware::class]);
$router->post('/store/storefront/carousel', 'Admin\\Storefront\\CarouselController@store', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->get('/store/storefront/carousel/{id}/edit', 'Admin\\Storefront\\CarouselController@edit', [AuthMiddleware::class]);
$router->post('/store/storefront/carousel/{id}', 'Admin\\Storefront\\CarouselController@update', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->post('/store/storefront/carousel/{id}/delete', 'Admin\\Storefront\\CarouselController@delete', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->get('/store/storefront/service-boxes', 'Admin\\Storefront\\ServiceBoxController@index', [AuthMiddleware::class]);
$router->get('/store/storefront/service-boxes/create', 'Admin\\Storefront\\ServiceBoxController@create', [AuthMiddleware::class]);
$router->post('/store/storefront/service-boxes', 'Admin\\Storefront\\ServiceBoxController@store', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->get('/store/storefront/service-boxes/{id}/edit', 'Admin\\Storefront\\ServiceBoxController@edit', [AuthMiddleware::class]);
$router->post('/store/storefront/service-boxes/{id}', 'Admin\\Storefront\\ServiceBoxController@update', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->post('/store/storefront/service-boxes/{id}/delete', 'Admin\\Storefront\\ServiceBoxController@delete', [AuthMiddleware::class, CsrfMiddleware::class]);
...
$router->post('/store/admin/settings/tax/update', 'Admin\SettingsController@updateTax', [AuthMiddleware::class, CsrfMiddleware::class]);
$router->post('/store/admin/settings/email/update', 'Admin\SettingsController@updateEmail', [AuthMiddleware::class, CsrfMiddleware::class]);
