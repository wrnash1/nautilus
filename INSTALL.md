...
Upload all Nautilus files to your web server's public directory (usually `/var/www/html/nautilus` or `/home/youruser/public_html/nautilus`).

### 2. Run Setup Script

Open a terminal/SSH connection to your server and run:
...
Edit the `.env` file (created by the setup script) with your database information:
...
This will verify all server requirements are met.

### 5. Run Installation

If all requirements pass, click "Proceed to Installation" or visit:
...
Visit `https://your-domain.com/simple-install.php` and follow the on-screen instructions.
...
- [ ] Delete or rename `simple-install.php`
...
rm public/simple-install.php
rm public/check-requirements.php
```
...
- **System Requirements**: Visit `/check-requirements.php` on your installation
